...
import com.obsudim.mypsychologist.databinding.FragmentTestHistoryBinding
...
import com.obsudim.mypsychologist.presentation.diagnostics.historyTestFragment.TestHistoryScreenState
import com.obsudim.mypsychologist.presentation.diagnostics.historyTestFragment.TestHistoryViewModel
...
class FragmentTestHistory : Fragment() {
    ...
    private fun clickListener(testResultId: String) {
        findNavController().navigate(
            R.id.action_hostTestFragment_to_result_test_graph, bundleOf(
